...
SELECT 
		        ...
		        SUM(CASE WHEN title IS NULL THEN 1 ELSE 0 END) AS nulls_title, 
				SUM(CASE WHEN year IS NULL THEN 1 ELSE 0 END) AS nulls_year,
		        SUM(CASE WHEN date_published IS NULL THEN 1 ELSE 0 END) AS nulls_date_published,
		        SUM(CASE WHEN duration IS NULL THEN 1 ELSE 0 END) AS nulls_duration,
				SUM(CASE WHEN country IS NULL THEN 1 ELSE 0 END) AS nulls_country,
		        SUM(CASE WHEN worlwide_gross_income IS NULL THEN 1 ELSE 0 END) AS nulls_worlwide_gross_income,
		        SUM(CASE WHEN languages IS NULL THEN 1 ELSE 0 END) AS nulls_languages,
		        SUM(CASE WHEN production_company IS NULL THEN 1 ELSE 0 END) AS nulls_production_company
